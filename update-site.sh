...
aws s3 cp . s3://hangman.sumarap.com --recursive --exclude ".*" --exclude "package.json" --exclude "node_modules/*" --exclude ".git/*" --exclude ".gitignore" --exclude "*.sh" --exclude ".DS*" --exclude ".psd" --exclude "playground/*"
